...
var generateReport = function (options) {
    ...
    var setStats = function (suite) {
        ...
        if(options.screenshotsDir) {
            screenShotDirectory = options.output ? path.join(options.output, '..', options.screenshotsDir) : options.screenshotsDir;
        }
        else {
            screenShotDirectory = options.output ? path.join(options.output, '..', "screenshots") : "screenshots";
        }
