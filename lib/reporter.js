...
var generateReport = function (options) {
     ...
     * @param suite
     */
    var setupSubSuiteTemplates = function(suite, options) {
    ...
    var setStats = function (suite) {
        ...
        featureOutput.forEach(function (feature) {
            ...
            var subSuite = hierarchyReporter.findOrCreateSubSuite(suite, feature);
    ...
    fs.writeFileSync(
        ...
        _.template(readFile('index.tmpl'))({
            ...
            piechart: ((options.theme === 'bootstrap') || (options.theme === 'hierarchy')) ? readFile('piechart.js') : undefined
        })
    );
