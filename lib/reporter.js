                    ...
                    if (step.embeddings !== undefined) {
                        step.embeddings.forEach(function (embedding) {
                            ...
                            if (embeddingType === 'text/plain' || embeddingType === 'text/html') {
                                ...
                                step.image.push('data:image/png;base64,' + embedding.data);
                              ...
                              step.text.push('<a href="'+file+'" download="file.'+fileType+'">download file</a>');
                            }
                        });
                    }

                    if (!step.result || (step.hidden && step.text.length === 0 && step.image.length === 0)) {
                        return 0;
                    }
