...
var generateReport = function (options) {
    ...
    var setStats = function (suite) {
        ...
        featureOutput.forEach(function (feature) {
            ...
            featuresSummary.isPending = false;
            ...
            if (options.reportSuiteAsScenarios) {
                ...
                suite.pending = suite.scenarios.pending;
    ...
    fs.writeFileSync(
        ...
        _.template(readFile('index.tmpl'))({
            ...
            styles: (options.theme === 'hierarchy') ? readFile('../bootstrap/style.css') : readFile('style.css'),
            script: (options.theme === 'hierarchy') ? readFile('../bootstrap/script.js') : readFile('script.js'),
            piechart: ((options.theme === 'bootstrap') || (options.theme === 'hierarchy')) ? readFile('../bootstrap/piechart.js') : undefined
        })
    );
